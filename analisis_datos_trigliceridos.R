...
acidos_grasos <- datos_limpios %>% 
  select(ID, provincia,cultivo_riego_secano,altitud,
        lll,ol_ln_po_ll,pl_ln,oll,oo_ln_po_ol,
         pll_po_po_o,po_ln_p_po_po_p_po_l,ool_ln_pp,po_oo,
        sll_plo,po_op_s_po_l_so_ln_s_po_po,plp,ooo_po_pp,
        sol,poo,pop,soo,pos_sls)
...
#po_ln_p_po_po_p_po_l: 0-2 (p = 0.0009997) y 1-2 (p = 0.02)
#po_op_s_po_l_so_ln_s_po_po: 0-2 (p = 0.0097593) y 1-2 (p = 0.0189599)
#plp : 1-2 (p = 0.0307111)
...
#po_ln_p_po_po_p_po_l: 0-2 (p = 0.0009997) y 1-2 (p = 0.02)
#po_op_s_po_l_so_ln_s_po_po: 0-2 (p = 0.0228317) y 1-2 (p = 0.0215736)
#plp : 1-2 (p = 0.0465487)

#poo: interaccion altitud y tipo de cultivo (p = 0.0356)
...
#lll : 0-2 (p = 0.01889283)
#ol_ln_po_ll  : 0-2 (p = 0.03779302)
#pl_ln  : 1-2 (p = 0.04296527)
#oo_ln_po_ol  : 0-2 (p = 0.007671619)
#ooo_po_pp  : 1-2 (p = 0.04488156)
...
#pl_ln  : 0-2 (p = 0.0447) y 1-2 (p = 0.0189)
#oo_ln_po_ol  : 0-2 (p = 0.0319) y 1-2 (p = 0.0293)
...
tabla_resumen_formato_final <- tabla_resumen_formato_final %>%
  mutate(Variable = c("LLL","OLLn + PoLL","PLLn","OLL","OOLn + PoOL",
                      "PLL + PoPoO","POLn + PPoPoL","OOL + LnPP","PoOO",
                      "SLL + PLO","PoOP + SPoL + SOLn + SPoPo", "PLP",
                      "OOO + PoPP", "SOL", "POO","POP", "SOO", "POS + SLS"))
