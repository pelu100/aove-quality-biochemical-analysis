...
acidos_grasos <- datos_limpios %>% 
  select(ID, provincia,cultivo_riego_secano,altitud,
        polifenoles_totales_ppm, hidroxitirosol,tirosol,
        x34dhpeaeda_descarb,x34dhpeaeda_descarb_ox,
...
nombres_acidos_grasos <- nombres_acidos_grasos[c(5:22)]
...
variables_normal_varianzas_iguales <-  c()
...
#polifenoles_totales_ppm: 0-2 (p = 0.0262275)
#x34dhpeaeda_descarb_ox : 0-2 (p = 0.0491603). 
#oleuropeina : 0-1 (p = 0.0394759).


#Tipo de cultivo

#x34dhpeaeda_descarb: p = 0.0425
#x34dhpeaeda: p = 0.034
#p_hpeaeda_descarb : p = 0.0448
#p_hpeaea: p = 0.0418
...
#acido_cinamico  : p = 0.0402. No se ha podido hacer post hoc
#p_hpeaeda   : 0-2 (p = 0.02847329)
#x34dhpeaea_ox_110 : 0-2 (p = 0.01386205)
...
#acido_cinamico  : 0-1 (p = 0.0367) y 0-2 (p = 0.0316).
#p_hpeaeda   : 0-1 (p = 0.0268) y 0-2 (p = 0.0422)
#x34dhpeaea_ox_107: 0-1 (p = 0.0178)
#x34dhpeaea_ox_110: 0-2 (p = 0.0281)

# Tipo de cultivo:

#p_hpeaeda: p = 0.015529 
#x34dhpeaea_ox_107: p = 0.020866
...
tabla_resumen_formato_final <- tabla_resumen_formato_final %>%
  mutate(Variable = c("Polifenoles totales","Hidroxitirosol","Tirosol",
                      "3,4-DHPEA-EDA-descarb","3,4-DHPEA-EDA-descarb-oxidada",
                      "Oleuropeina","3,4-DHPEA-EDA","Tirosil_acetato","p-HPEA-EDA-descarb-oxidada",
                      "p-HPEA-EDA-descarb","Pinoresinol","Ácido cinámico","p-HPEA-EDA",
                      "3,4-DHPEA-EA-oxidada (1)","3,4-DHPEA-EA","Luteolina",
                      "3,4-DHPEA-EA-oxidada (2)","p-HPEA-EA"
                      ))
