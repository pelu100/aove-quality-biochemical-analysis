...
acidos_grasos <- datos_limpios %>% 
  select(ID, provincia,cultivo_riego_secano,altitud,
         beta_amirina,butirospermol,cicloartenol,x24_metilencicloartenol,
         citrostadienol)
...
nombres_acidos_grasos <- nombres_acidos_grasos[c(5:9)]
...
#  b_sitosterol_individual: 1-0 (p = 0.0410835) y 2-0 (p = 0.0050415)
...
# b_sitosterol_individual:2-0 (p = 0.0260983). No hay diferencias entre tipo de cultivo
...
# x24_metilencolesterol: entre 0-2 (p = 0.005028368)
# clerosterol: entre 0-2 (p = 0.00726261)
# d_5_avenasterol: entre 0-2 (p = 0.007354933)
...
#  x24_metilencolesterol : 0-2 ( p = 0.0090). El tipo de cultivo casi afecta tambien (p = 0.0547842)
#  clerosterol : 0-1 ( p = 0.0127) y 0-2 (p = 0.0012)
# d_5_avenasterol: 0-2 (p = 0.0044)


# Tipo de cultivo:
# d_5_23_estigmastadienol: p = 0.021586
# sitostanol: p = 0.0033034. Interaccion altitud y tipo de cultivo (p = 0.0333162)
...
tabla_resumen_formato_final <- tabla_resumen_formato_final %>%
  mutate(Variable = c("Esteroles totales", "Colesterol",
                      "24-Metilencolesterol", "campesterol","estigmasterol",
                      "Delta-5,23-estigmastadienol","Clerosterol",
                      "Beta-sitosterol individual", "Sitostanol",
                      "Delta-5-avenasterol", "Delta-5,24-estigmastadienol",
                      "Delta-7-estigmastenol", "Delta-7-avenasterol",
